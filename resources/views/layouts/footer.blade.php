            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-9">
                    <section class="footer-item">
                        <a href="/" class="logo footer-logo"><img src="assets/images/logo.png" alt="biolife logo" width="135" height="20"></a>
                        <div class="footer-phone-info">
                            <i class="biolife-icon icon-head-phone"></i>
                            <p class="r-info">
                                <span>Liên Hệ ?</span>
                                <span>(+84)  34 8485 360</span>
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                    <section class="footer-item">
                        <h3 class="section-title">Văn Phòng Thông Tin Liên Hệ</h3>
                        <div class="contact-info-block footer-layout xs-padding-top-10px">
                            <ul class="contact-lines">
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-location"></i>
                                        <b class="desc">148 Ỷ Lan Nguyên Phi - Hòa Cường Bắc - Hải Châu - Đà Nẵng</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-phone"></i>
                                        <b class="desc">Phone: 034 8485 360</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-letter"></i>
                                        <b class="desc">Email:  ruoudn_43@gmail.com</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
