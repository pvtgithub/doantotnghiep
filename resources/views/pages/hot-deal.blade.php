...
<div class="container">
	<div class="row">
		<section id="left-sidebar" class="col-md-3 col-sm-4">
			...
			<aside id="filter-bar">
				<h1>Bộ tìm kiếm</h1>
				<h2><a href="hot-deal">Hot Deal</a></h2>
				<hr>
				<form id="frm-filter-hot-deal" action="https://www.sieuthiruoungoai.com/product/filter" method="post">
		...
		<main id="product-list" class="col-xs-12 col-md-9 col-sm-8">
			<div class="block-title">&nbsp;
				<h1>Hot Deal</h1>
				<div>
					<input id="search-hot-deal" type="text" name="search-kho" placeholder="Tìm kiếm...">
					<select id="sort-box-hot-deal">
